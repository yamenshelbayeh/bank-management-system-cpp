...
private :
    ...
    static vector <stLoginRegisterRecord> _LoadLoginRegisterDataFromFile() {
        ...
        vector <stLoginRegisterRecord> Logins;
...
public :
    ...
    enum enPermissions {
        PAll = -1, PShow = 1, PAdd = 2, PDelete = 4, PUpdate = 8, PFind = 16,
    ...
    static vector <stLoginRegisterRecord> GetLoginRegisterList() {
     ...
     bool CheckAccessPermission(enPermissions PermissionChoice) {

        return ((this->Permissions == clsUser::PAll) || ((this->Permissions & PermissionChoice) == PermissionChoice));
